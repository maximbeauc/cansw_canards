...
// w_status_t estimator_step(estimator_module_ctx_t* ctx,
//     navigator_input_t* p_input,
...
//     // if (xQueueReceive(encoder_data_queue_rad, &latest_encoder_rad, pdMS_TO_TICKS(4)) ==
//     pdTRUE) {
...
//     // TODO: consider how the new fsm should behave if not in these state, currently just hard
//     set
//     // to 0
...
//                                                 .pololu_is_dead =
//                                                 p_latest_imu_data->pololu.is_dead, .cmd =
//                                                 latest_controller_cmd, .encoder =
//                                                 latest_encoder_rad, .encoder_is_dead =
//                                                 encoder_is_dead };
...
//         (float)p_controller_input->roll_state.roll_rate;
...
//         log_payload.estimator_ctx_pt3.t_ms = (uint32_t)(ctx->t_sec * 1000.0);
